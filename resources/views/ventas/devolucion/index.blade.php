...
<div class="row">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		<h3>Venta - Listado de Devolución<br></h3>
	</div>
</div>
			...
			<table id="vistaIngreso" class="table table-striped table-bordered table-condensed table-hover">
               ...
               @foreach ($ingresos as $ing)
				<tr>
					...
					<td>{{ $ing->serie_comprobante}}-{{ $ing->numero_comprobante}}</td>
					...
					<td>
						<a href="{{route('dtdevv',$ing->id_devolucion)}}" target="_blank"  title="Ver Más" ><button class="btn btn-success">Detalle</button></a>
					
						<a href="{{route('dtprintv',$ing->id_devolucion)}}" title="Imprimir/Descargar" target="_blank"  ><button class="btn btn-primary"><i class="fa fa-file-o"></i></button></a>
		...
		buttons: [
			{
				extend: "excel",
				footer: true,
				title: "Lista de Devolucion Venta",
				filename: "devolucionven",
