			...
			<div class="col-md-12">
			                ...
			                <div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" name="serie_comprobante" id="idserie_comprobante" required readonly  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="7" value="{{old('serie_comprabante')}}" class="form-control" placeholder="000-000">
								</div>
							</div>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" name="numero_comprobante" id="idnumero" required readonly  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="9" value="{{old('numero_comprabante')}}" class="form-control" placeholder="000000000">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
